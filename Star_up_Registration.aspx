<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Star_up_Registration.aspx.cs" Inherits="Investor_Registration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2 class="mt-4" style="text-align:center" >startup  Registration </h2>
        <br />
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <label for="txtInvestorName" class="form-label">startup  Name:</label>
        ...
        <div class="col-lg-6">
         ...
         <div class="col-lg-6">
            <div class="form-group">
                ...
                <asp:DropDownList ID="ddlcategory" runat="server"   class="form-control" placeholder=" Category" >
