<%@ Page Title="" Language="C#" MasterPageFile="~/Invester/In_MasterPage.master" AutoEventWireup="true" CodeFile="demo.aspx.cs" Inherits="Invester_demo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="flex flex-col">
    ...
    <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="images/brand-01.svg" alt="Brand">
        </div>
    ...
    <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="images/brand-02.svg" alt="Brand">
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Twitter
        </p>
    ...
    <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="images/brand-03.svg" alt="Brand">
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Github
        </p>
    ...
    <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="images/brand-04.svg" alt="Brand">
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Vimeo
        </p>
    ...
    <div class="grid grid-cols-3 sm:grid-cols-5">
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="images/brand-05.svg" alt="Brand">
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Facebook
        </p>
