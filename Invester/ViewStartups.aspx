<%@ Page Title="" Language="C#" MasterPageFile="~/Invester/In_MasterPage.master" AutoEventWireup="true" CodeFile="ViewStartups.aspx.cs" Inherits="Invester_ViewStartups" %>
...
<div class="im h r s df vd yc wg tc wf xf al hh/20 nl il z-10">
    ...
    <a href="info_project.aspx?pi_id=<%# Eval("pi_id") %>&st_id=<%# Eval("st_id") %> " 
...
<div class="tc wf ag">
<img  style="color: brown" src="../images/icon-man.png" alt="User">
<p  style="color:forestgreen" ><%# Eval("FirmName") %></p>
</div>

</div>
<h4 class="ek tj ml il kk wm xl eq lb">
<a href="<%# Eval("Website") %>"    target="_blank" ><%# Eval("Projectname") %></a>
</h4>
</div>
</div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                       ...
                       SelectCommand="SELECT     upi.ProjectImage,upi.pi_id, upi.st_id, upi.Website,  upi.Projectname, sur.FirmName
FROM  Upload_Project_Idea upi JOIN  Star_UpRegistration sur ON upi.st_id = sur.st_id">
    </asp:SqlDataSource>
